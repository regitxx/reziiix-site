          ...
          <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-12 px-4 pb-20 pt-24 md:flex-row md:items-center md:pb-28 md:pt-28">
            ...
            >
              ...
              <p className="max-w-md text-sm leading-relaxed text-neutral-200 md:text-[15px]">
                REZIIIX designs and ships production-grade AI agents embedded in
                your existing tools. They handle real workflows, log every
                decision, and hand control back to humans when needed.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-neutral-300">
                ...
                Singapore · working with global teams
              </span>
              </div>
            </motion.div>
            ...
            <ParallaxContainer>
              ...
              >
                    ...
                    <div className="grid gap-3 md:grid-cols-[1.3fr,1fr]">
                      ...
                      <div className="space-y-2 rounded-2xl border border-neutral-700 bg-neutral-950/85 p-2.5 text-[11px] text-neutral-100">
                        ...
                        <div className="mt-2 space-y-1 rounded-xl border border-neutral-700 bg-black/80 p-2 text-[10px] text-neutral-300">
                          ...
                          <p>
                            If confidence &lt; 0.85 or data incomplete → assign to
                            human, attach summary + suggested next steps.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <p className="mt-3 text-[11px] text-neutral-400">
                  This is what we actually build: a running agent inside your
                  stack, with logs, metrics, and clear rules for when humans stay
                  in the loop.
                </p>
              </motion.div>
            </ParallaxContainer>
            ...
            <div className="grid gap-8 md:grid-cols-[minmax(0,1.1fr),minmax(0,1fr)]">
              <motion.div className="space-y-4" variants={staggerItem}>
                ...
                <p className="text-xs text-neutral-300">
                  Email:{" "}
                  <span className="text-neutral-100">hello@reziiix.com</span>
                </p>
              </motion.div>
...
function IntroSplash() {
  ...
  // fade + slight zoom as you scroll down
  const opacity = useTransform(scrollYProgress, [0, 0.4, 1], [1, 0.75, 0]);
  ...
  return (
      <motion.section
          ...
          className="relative flex min-h-[90vh] items-center justify-center overflow-hidden border-b border-neutral-900/70 bg-gradient-to-b from-slate-950 via-slate-950 to-black"
      >
        {/* background glows */}
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-40 left-1/2 h-80 w-[34rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(56,189,248,0.7),transparent_65%)] blur-3xl" />
          <div className="absolute bottom-[-10rem] left-1/2 h-96 w-[36rem] -translate-x-1/2 rounded-full bg-[radial-gradient(circle_at_center,rgba(129,140,248,0.6),transparent_65%)] blur-3xl" />
        </div>

        {/* rotating rings behind wordmark */}
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <motion.div
              initial={{ rotate: 0 }}
              animate={{ rotate: 360 }}
              transition={{ duration: 36, repeat: Infinity, ease: "linear" }}
              className="h-[26rem] w-[26rem] rounded-full border border-cyan-400/25"
          />
          <motion.div
              initial={{ rotate: 0 }}
              animate={{ rotate: -360 }}
              transition={{ duration: 52, repeat: Infinity, ease: "linear" }}
              className="absolute h-[19rem] w-[19rem] rounded-full border border-violet-400/25"
          />
        </div>
        ...
        >
          ...
          <motion.span
              ...
              className="select-none bg-[linear-gradient(120deg,#e5f2ff,#38bdf8,#a855f7,#fb7185)] bg-clip-text text-[clamp(3.75rem,15vw,10.5rem)] font-semibold tracking-[0.26em] text-transparent drop-shadow-[0_0_45px_rgba(15,23,42,1)]"
          ...
          {/* subtle outline glow */}
          <div className="pointer-events-none absolute inset-x-0 top-[54%] -z-10 mx-auto h-40 max-w-[34rem] rounded-full border border-cyan-300/15 bg-[radial-gradient(circle_at_center,rgba(15,23,42,0.9),transparent_70%)] blur-xl" />

          <p className="max-w-md text-[11px] uppercase tracking-[0.3em] text-neutral-200">
            Focused AI automation studio for teams who want agents
            <span className="hidden sm:inline"> in their real stack</span>, not
          ...
          <motion.button
              ...
              className="mt-6 flex flex-col items-center gap-2 text-[11px] text-neutral-300 focus:outline-none"
          >
            <div className="flex items-center gap-2">
              <div className="h-[1px] w-12 bg-neutral-600/80" />
            ...
            <motion.span
                ...
                className="inline-flex h-9 w-9 items-center justify-center rounded-full border border-cyan-400/70 bg-black/70 shadow-[0_0_22px_rgba(56,189,248,0.55)]"
            >
              ↓
            </motion.span>
          </motion.button>
        ...
        <div className="mx-auto max-w-5xl px-4 py-16 md:py-20">
          ...
          >
            ...
            <p className="max-w-sm text-xs leading-relaxed text-neutral-500">
              We don&apos;t ship toy demos. Each engagement ends with a running
              system, observable behavior, and a clear next workflow to automate.
            </p>
          </motion.div>
...
function SystemsStory() {
  ...
  const triageOpacity = useTransform(
      scrollYProgress,
      [0, 0.15, 0.35],
      [1, 1, 0.25]
  );
  ...
  const execOpacity = useTransform(
      scrollYProgress,
      [0.5, 0.75, 1],
      [0.2, 1, 1]
  );
...
function ExampleAgents() {
  ...
  return (
      <section
          id="agents"
          className="border-b border-neutral-900 bg-black w-full"
      >
...
function WorkflowNode({ title, body, strong }: WorkflowNodeProps) {
  return (
      ...
      >
        ...
        <p className="text-[11px] leading-relaxed text-neutral-200 md:text-xs">
          {body}
        </p>
      </div>
  );
